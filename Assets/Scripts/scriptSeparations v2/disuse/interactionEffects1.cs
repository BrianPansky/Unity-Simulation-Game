...
public class interactionSubAtom
{
    ...
    public void doThisSubAtomEffect(string theSubAtomEffect, interactionMate theInteractionMate)
    {
        ...
        else if(theSubAtomEffect == "standardInteraction1")
        {
            ...
            //Debug.DrawLine(authorBody.lookingRay.origin, (authorBody.lookingRay.origin + (authorBody.lookingRay.direction*7)), Color.magenta, 0.1f);
        ...
        else if (theSubAtomEffect == "justActivateLock")
        {
            if (theInteractionMate.interactionAuthor.GetComponent<inventory1>().testInventory1.Contains("testKey1") == true)
            {
                ...
                interactionEffects1 authorInteractionScript = theInteractionMate.interactionAuthor.GetComponent<interactionEffects1>();
        ...
        else if (theSubAtomEffect == "aShootingEnaction")
        {
            theInteractionMate.interactionAuthor.GetComponent<Renderer>().material.color = new Color(1f, 0f, 0f);

            body1 authorBody = theInteractionMate.interactionAuthor.GetComponent<body1>();
            GameObject makeThis = authorBody.theWorldScript.theRespository.placeHolderCubePrefab;

            GameObject thisObject = authorBody.theWorldScript.theRespository.createPrefabAtPointAndRETURN(makeThis, theInteractionMate.interactionAuthor.transform.position);
            ...
            selfDestructScript1 killScript = thisObject.AddComponent<selfDestructScript1>();
            killScript.delay = 130;

            //      should this use "interactionMate" isntead?
            authorScript1 theAuthorScript = thisObject.AddComponent<authorScript1>();
            theAuthorScript.theAuthor = theInteractionMate.interactionAuthor;
            theAuthorScript.enactThisInteraction = theInteractionMate.enactThisInteraction;
            theAuthorScript.interactionType = "bullet1";
        }
        //hitByBullet
        else if (theSubAtomEffect == "hitByBullet")
        {
            Debug.Log("this SHOULD destroy the AI...................................................................................................................................................");
            //Debug.Log(UnityEngine);
            //Debug.Log(UnityEngine.Object);
            Debug.Log(theInteractionMate.enactOn);
            Debug.Log(theInteractionMate.enactOn.GetComponent<AIHub2>());
            UnityEngine.Object.Destroy(theInteractionMate.enactOn.GetComponent<AIHub2>());
        }
